...
from component_interfaces import (
    ReasoningConfig, TerminationReason
)
...
class AIGeneratorV2:
    ...
    def __init__(self, api_key: str, model: str, tool_manager=None):
        ...
        self.tool_dispatcher = ToolDispatcher(tool_manager, self.config) if tool_manager else None
    ...
    def _store_sources_for_retrieval(self, sources: List[Dict[str, Any]], tool_manager) -> None:
        """
    ...
    def terminate_session(self, session_id: str, reason: TerminationReason = TerminationReason.USER_CANCELLATION):
