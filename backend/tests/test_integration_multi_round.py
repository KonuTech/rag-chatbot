...
- Java: More structured, enterprise-focused, strongly typed"""
    ...
    def test_error_handling_with_fallback(self, mock_asyncio_run):
        ...
        mock_response = Mock()
        mock_response.content = [Mock(text="I can help you with course-related questions. Could you please be more specific?")]
        mock_response.stop_reason = "end_turn"
        self.mock_client.messages.create.return_value = mock_response
    ...
    def test_source_tracking_integration(self):
        ...
        # Configure source tracking
        test_sources = [
            {"text": "Python Fundamentals - Lesson 1", "url": "https://example.com/python/lesson1"},
            {"text": "Java Programming - Lesson 2", "url": "https://example.com/java/lesson2"}
        ]
