...
class TestRAGSystem:
    ...
    def test_query_with_conversation_history(self):
        ...
        response, sources = self.rag_system.query(
            "Tell me about Python", session_id="test_session"
        )
    ...
    def test_query_tool_manager_failure(self):
        ...
        self.mock_tool_manager.get_last_sources.side_effect = Exception(
            "Tool manager error"
        )
...
class TestRAGSystemIntegration:
    ...
    def test_content_query_full_flow(self):
        ...
        # Execute the query
        response, sources = self.rag_system.query(
            "What is Python used for?", session_id="session_123"
        )
